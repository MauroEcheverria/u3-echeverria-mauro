...
from viz import load_iris_data, create_sepal_length_histogram, create_pair_plot
...
@patch('viz.plt.show')  # "Mockea" (simula) la función plt.show para que el gráfico no se muestre
